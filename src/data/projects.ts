...
export const projects: Project[] = [
  {
    id: 'gesture-app',
    title: 'Gesture App',
    tagline: 'Real-time hand-gesture recognition, entirely in the browser',
    description:
    ...
    highlights: [
      'Model self-hosted and WASM runtime pinned, so it works offline and never breaks on a CDN change',
      'CV pipeline isolated in framework-free modules; React hooks are the only bridge to the UI',
    ],
...

   {
    ...
    description:
      'A two-layer closed-loop controller that distributes torque between the wheels of an electric race car to improve cornering, built on Pacejka tyre modelling and load-transfer effects. Simulated in IPG CarMaker across AWD, RWD, in-hub and in-board drivetrain layouts against an equal-torque baseline. Four-person team; co-authored the 40-page group dissertation.',
    highlights: [
  ...
  },
  {
    ...
    description:
      'Attitude control of a quadrotor whose rotational inertias are on the order of 1e-4 kg m^2, so the dynamics play out in milliseconds. Modelled and linearised the plant, designed a constrained linear MPC (rotor torque limited to 0.25 N m), then applied it to the full nonlinear plant and compared it against a nonlinear MPC on step tracking, impulse-disturbance rejection and robustness to 55% inertia and 75% damping uncertainty.',
    highlights: [
      'Spec: +/-10 degree roll and pitch steps with under 1 s rise time and under 5% overshoot',
      'Monte Carlo robustness sweep over perturbed plants using a single fixed controller',
    ],
 ...
 
  {
    ...
    description:
      'A second iteration of my from-scratch feed-forward network. The first version (Eigen-based) reached 97.4% on MNIST; this rewrite drops Eigen for a hand-written matrix library, adds a proper CMake build and tests, and uses OpenMP to parallelise mini-batch training. The goal is a clean, dependency-free reference implementation that I understand line by line.',
